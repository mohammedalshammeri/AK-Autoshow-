...
export default function AdminEditRegistrationPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-400">Registration ID: <span className="font-mono">{id}</span></p>
          </div>
